...
BuildRequires:  make
BuildRequires:  %{?scl_prefix}perl-interpreter >= 4:5.22.0-351
...
Requires:       %{?scl_prefix}perl-interpreter >= 4:5.22.0-351
...
%build
%{?scl:scl enable %{scl} 'PERL_NS=%{scl} }perl Makefile.PL INSTALLDIRS=vendor INSTALLVENDORSCRIPT=%{_rpmconfigdir} NO_PACKLIST=1%{?scl:'}
